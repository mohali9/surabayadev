  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#home"><img src="img/navbar/logo.png" width="140"></a>
      </div>

      <nav class="collapse navbar-collapse" id="list">
        <ul class="nav navbar-nav navbar-right" class="text">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel" style="padding-top: 56px;">
    ...
    <div id="home" class="carousel-inner">
      ...
      <div class="item active">
        <img src="img/slide/foto.jpg" alt="Home View" style="width:100%; opacity:0.1;">
        <div class="carousel-caption">
          ...
          <div class="">
            <img src="img/navbar/logo.png" alt="" style="width:50%; margin-left:530px;margin-bottom:190px;">
          </div>
        </div>
      </div>

      <div class="item">
        <img src="img/slide/foto.jpg" alt="" style="width:100%;">
        <div class="carousel-caption">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="thumbnail">
            ...
            <a href="#" target="_blank">
              <img src="img/event/event1.jpg" alt="Lights" style="width:100%">
              <div class="caption">
        ...
        <div class="col-md-4">
          <div class="thumbnail">
            ...
            <a href="#" target="_blank">
              <img src="img/event/event2.jpg" alt="Nature" style="width:100%">
              <div class="caption">
       ...
       <div class="col-md-4">
        <div class="thumbnail">
          ...
          <a href="#" target="_blank">
            <img src="img/event/event3.jpg" alt="Fjords" style="width:100%">
            <div class="caption">
...
<div class="container">
  <div class="row">
    ...
    <img src="img/tele.png" alt="" width="auto" height="auto" style="width:100%">
  </div>
</div>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <?php foreach (range(1, 4) as $value): { ?>
        <?php if ($value == 1 && $value == 4): ?>
          <?php echo $value ?>
          <?php else: echo "salah"; ?>
            <div class="col-md-4">
              <div class="thumbnail">
                <a href="#" target="_blank">
                  <img src="img/galeri/<?= $value; ?>.jpg" alt="Lights" style="width:100%">
                </a>
              </div>
            </div>
          <?php endif ?>
...
<!-- 
      <div class="col-md-4">
        <div class="thumbnail">
          <a href="#" target="_blank">
            <img src="img/galeri/1.jpg" alt="Nature" style="width:100%">
          </a>
        </div>
      </div>
      <div class="col-md-4">
        <div class="thumbnail">
          <a href="#" target="_blank">
            <img src="img/galeri/2.jpg" alt="Fjords" style="width:100%">
          </a>
        </div>
      </div>
      <div class="col-md-4">
        <div class="thumbnail">
          <a href="#" target="_blank">
            <img src="img/galeri/1.jpg" alt="Lights" style="width:100%">
          </a>
        </div>
      </div> -->
      ...
      <div class="col-md-4">
        <div class="thumbnail">
          <a href="#" target="_blank">
            <img src="img/galeri/3.jpg" alt="Nature" style="width:100%">
          </a>
        </div>
      </div>
      <div class="col-md-4">
        <div class="thumbnail">
          <a href="#" target="_blank">
            <img src="img/galeri/4.jpg" alt="Fjords" style="width:100%">
          </a>
        </div>
      </div>
    </div>
...
<div id="blog">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-6">
        <img src="img/galeri/4.jpg" alt="4" style="width:80%;">
      </div>
      <div class="col-md-6">
...
<div id="katamereka" style="background-color:#f7f7f7; height:710px; margin-top:100px; padding-top:100px;">
  <div class="container-fluid bg-white" style="width:55%; margin-top:200px; height:320px">
    <div class="row">
      ...
      <img src="img/burisma.png" alt="burisma" style="width:28%; margin-left:240px;">
  ...
  <div class="container text-center">
    ...
    <div class="row">
      <div class="col-xs-6 col-md-3">
        <a href="#">
          <img src="img/support/sponsor_niagahoster.png" alt="Niaga Hoster" style="width: 100%;">
        </a>
      </div>
      <div class="col-xs-6 col-md-3">
        <a href="#">
          <img src="img/support/sponsor_dilo.png" alt="dilo" style="width: 100%;">
        </a>
      </div>
      <div class="col-xs-6 col-md-3">
        <a href="#">
          <img src="img/support/sponsor_jetbrains.png" alt="jetbrains" style="width: 100%;">
        </a>
      </div>
      <div class="col-xs-6 col-md-3">
        <a href="#">
          <img src="img/support/sponsor_indigo.png" alt="indigo" style="width: 100%;">
        </a>
      </div>
    </div>
  </div>
...
<div class="footer">
  <div class="container">
    ...
    <div class="pull-right">
      <a href="#"><img src="img/footer/wa.png" alt="Whatsapp" width="25" height="25"></a>
      <a href="#"><img src="img/footer/fb.png" alt="Facebook" width="25" height="25"></a>
      <a href="#"><img src="img/footer/ig.png" alt="Instagram" width="25" height="25"></a>
      <a href="#"><img src="img/footer/twitter.png" alt="Twitter" width="25" height="25"></a>
      <a href="#"><img src="img/footer/google.png" alt="Google+" width="25" height="25"></a>
    </div>
  </div>
</div>
<!-- Optional JavaScript -->
